...
mlflow.set_tracking_uri('https://dagshub.com/KashifSad/mini-mlops-project.mlflow')
dagshub.init(repo_owner='KashifSad', repo_name='mlops-mini-project', mlflow=True)
